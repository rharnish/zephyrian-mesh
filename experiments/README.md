...
> |---|---|---|
> | Real C1+C2 protocol vs. omniscient connectivity | [`protocol-results/`](protocol-results/) (which also holds the density-sweep chart) | [`protocol_sweep.rs`](../sim-server/src/bin/protocol_sweep.rs) |
